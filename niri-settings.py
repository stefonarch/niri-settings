...
class BehaviorTab(QWidget):
    ...
    def init_ui(self):
        ...
        behavior_layout.addWidget(self.warp_mouse_to_focus_checkbox)
        behavior_layout.addWidget(self.focus_follows_mouse_checkbox)
    ...
    def save_behavior_config(self):
        ...
        try:
            with open(self.config_path, 'w') as f:
                f.write('// Generated by niri-settings \n// Edits will be overwritten!\n\n')
                f.write('input {\n')
            ...
            print(f"Error saving behavior configuration: {e}")
    ...
    def save_keyboard_config(self):
        ...
        try:
            with open(self.config_path, 'a') as f:  # Append to the file
                ...
                if path:
                    f.write(f'screenshot-path "{path}"\n')
